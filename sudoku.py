...
class Game2048(Frame):
    def __init__(self):
        ...
        self.commands = {
            c.KEY_UP: logicfinal.move_up,
            c.KEY_DOWN: logicfinal.move_down,
            c.KEY_LEFT: logicfinal.move_left,
            c.KEY_RIGHT: logicfinal.move_right
        }
        self.grid_cells = []
        self.init_grid()
        self.init_matrix()
    ...
    def key_down(self, event):
        ...
        if key in self.commands:
            ...
            if changed:
                ...
                elif logicfinal.get_current_state(self.matrix) == 'LOST':
                    self.grid_cells[1][1].configure(text="You", bg=c.BACKGROUND_COLOR_CELL_EMPTY)
